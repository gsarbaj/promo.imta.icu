export const Data = {
    ...
    Logo: {img: '/img/logo_imta_white.png', alt: 'Разработка сайтов, реклама в интернете', to: '/ru/google-campaign'},
    
    FirstScreen: {
        title: 'Привлекайте больше клиентов с помощью Instagram Рекламы',
        subtitle: 'Полный набор для привлечения клиентов: разработка рекламной компании Instagram, посадочная страница и подключение CRM',
    ...
    ProductsOffer: {
        ...
        subTitle: 'Полный набор инструментов для привлечения клиентов. Реклама в Instagram, Посадочная страница для вашего бизнеса и CRM для обработки клиентов как проффесионал',
        Products: [
            {productTitle: 'Рекламная компания Instagram', productDescription: 'Большенство людей видят товары и услуги в Instagram, раскажи им о себе', img: '/img/img_box_01.png'},
    ...
    meta:{
        title: 'Получи клиентов из Интернета - Реклама в Google',
        keywords: 'Google Ads, Реклама в Google, Привлечение Клиентов',
        description: 'Привлекайте больше клиентов с помощью Google Рекламы, разработка рекламных компаний и создание сайтов',
    }
