export const Data = {
    ...
    FirstScreen: {
        ...
        subtitle: 'Полный набор для привлечения клиентов: разработка рекламной компании Google, посадочная страница и подключение CRM',
    ...
    ProductsOffer: {
        ...
        subTitle: 'Полный набор инструментов для привлечения клиентов. Реклама в Google, Посадочная страница для вашего бизнеса и CRM для обработки клиентов как проффесионал',
        Products: [
            {productTitle: 'Рекламная компания Google', productDescription: 'Большенство людей ищут товары и услуги в Google, раскажи им о себе', img: '/img/img_box_01.png'},
